...
class TestEdwardsBandersnatch(unittest.TestCase):
    ...
    def set_up_curve(self):
        ...
        try:
            ...
            raise unittest.SkipTest(
                "The file 'tests/vectors/edwards-bandersnatch.py' was not found. Please generate it using `sage sage/edwards.sage > tests/vectors/test_edwards.py`.")
