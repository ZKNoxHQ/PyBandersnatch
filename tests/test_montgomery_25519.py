...
class TestMontgomery25519(unittest.TestCase):
    ...
    def set_up_curve(self):
        ...
        """
        try:
            with open('tests/vectors/montgomery-25519.py', "r") as file:
    ...
    #         x += 1
    #         print((x**3 + E.a*x**2 + x).is_square(),
    #               not (E(E.field(x), 1).is_prime_order(E.r)))
    #     g = E(E.field(x), 1)
