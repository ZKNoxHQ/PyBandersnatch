...
class BenchField(unittest.TestCase):

    def set_up_field(self):
        """Create Bandersnatch base field.

        Test vectors generated using `sage sage/field.sage > tests/vectors/field.py`.
    ...
    def test_bench_arithmetic(self):
    ...
    # def test_bench_larger_field(self):
    #     for p in [
